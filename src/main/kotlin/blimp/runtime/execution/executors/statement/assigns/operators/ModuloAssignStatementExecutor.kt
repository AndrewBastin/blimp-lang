...
import blimp.syntax.statement.statements.assigns.operators.ModuloAssignStatement

object ModuloAssignStatementExecutor: StatementExecutor<ModuloAssignStatement>() {
    override fun execute(n: ModuloAssignStatement, env: Environment) {
            ...
            if (env.objects[n.identifier]!!.mutable) {
                ...
                if (obj.type == env.objects[n.identifier]!!.type) {
                    ...
                    env.objects[n.identifier] = env.objects[n.identifier]!!.copy(
                        value = env.objects[n.identifier]!!.type.typeOperator.mod(env.objects[n.identifier]!!, obj).value
                    )
