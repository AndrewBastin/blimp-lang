...
import blimp.syntax.statement.statements.assigns.operators.SubtractAssignStatement

object SubtractAssignStatementExecutor: StatementExecutor<SubtractAssignStatement>() {
    override fun execute(n: SubtractAssignStatement, env: Environment) {
            ...
            if (env.objects[n.identifier]!!.mutable) {
                ...
                if (obj.type == env.objects[n.identifier]!!.type) {
                    ...
                    env.objects[n.identifier] = env.objects[n.identifier]!!.copy(
                        value = env.objects[n.identifier]!!.type.typeOperator.sub(env.objects[n.identifier]!!, obj).value
                    )
