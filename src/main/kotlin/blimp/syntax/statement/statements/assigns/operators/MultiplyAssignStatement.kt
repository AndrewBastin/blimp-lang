...
import blimp.lex.tokens.doublechar.MultiplyAssignToken
...
class MultiplyAssignStatement(val identifier: String, val expr: ExpressionStatement): Statement() {

    companion object : StatementProvider<MultiplyAssignStatement>() {
        ...
        override fun create(tokens: List<Token>): MultiplyAssignStatement {
            ...
            if (env.objects[identifier]!!.mutable) {
                ...
                if (obj.type == env.objects[identifier]!!.type) {
                    ...
                    env.objects[identifier] = env.objects[identifier]!!.copy(
                        value = env.objects[identifier]!!.type.typeOperator.mul(env.objects[identifier]!!, obj).value
                    )
