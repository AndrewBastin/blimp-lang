...
class MultiplyAssignStatement(val identifier: String, val expr: Expression): Statement() {
    ...
    companion object Emitter: NodeEmitter() {
        ...
        override fun getNode(tokens: List<Token>): Node {
            ...
            return MultiplyAssignStatement(identifier.identifier, Expression.create(exprTokens))
